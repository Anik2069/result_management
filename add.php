...
$vv = mysqli_query($connection, "select * from student where department = '$v1' and session='$v2' and year='$v3'");
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 style="text-align:center;">Add Student Result</h5>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="table-1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        Theory:&nbsp;&nbsp;&nbsp;<input type="number" name="theory[]">
                                                        MCQ:&nbsp;&nbsp;&nbsp;<input type="number" name="mcq[]">
                                                        Practical:&nbsp;&nbsp;&nbsp;<input type="number" name="prac[]">
                                                    </td>
                            ...
                            if(isset($_POST["submit"])){
                                ...
                                for($i=0;$i<$c;$i++){
                                    ...
                                    $p=$prac[$i];
                                    $ss=$sid[$i];
                                    $wury=mysqli_query($connection,"insert into result values (null,'$n','$r','$tom','$t','$m','$p','$v1','$v2','$v3','$v4','$ss')");
